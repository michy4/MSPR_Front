...
<div id="demo">
        ...
        <div class="card blue-grey darken-1">
            <div class="card-content white-text">
                ...
                <form action="index.php" method="post" class="form-example">
                    ...
                    <div class="form-example">
                        <label for="email">Enter your password: </label>
                        <input type="password" name="password" id="password_connexion"
                               required>
                    </div>
                    <div class="button form-example card-action">
    ...
    <div class="template">
        <template v-if="!viewConnexion"><p>Déjà chez nous? Connectez-vous <i class="blue-text"
                                                                             v-on:click="toggleConnexion"><a>ici</a></i>.
            </p></template>
        <template v-if="viewConnexion"><p>Nouveau chez nous? Inscrivez-vous <i class="blue-text"
                                                                               v-on:click="toggleConnexion"><a>ici</a></i>.
            </p></template>
    </div>
</div>
